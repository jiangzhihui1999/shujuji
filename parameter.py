...
train_ct_path = 'F:/train/ct'  # 原始训练集CT数据路径

train_seg_path = 'F:/train/seg'  # 原始训练集标注数据路径

test_ct_path = 'D:\BaiduNetdiskDownload\LITS-Challenge-Test-Data/'  # 原始测试集CT数据路径

test_seg_path = 'C:/users/zs/Desktop/dataset/MICCAI-LITS-2017/test/seg/'  # 原始测试集标注数据路径

training_set_path = './train/'  # 用来训练网络的数据保存地址

pred_path = 'C:/users/zs/Desktop/dataset/MICCAI-LITS-2017/test/liver_pred'  # 网络预测结果保存路径

crf_path = 'C:/users/zs/Desktop/dataset/MICCAI-LITS-2017/test/crf'  # CRF优化结果保存路径
